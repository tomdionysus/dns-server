...
class DNSPacket {
  ...
  _writeResourceRecord (ser, data, isQuestion) {
    ...
    switch (data.qtype) {
      case DNSPacket.QType.A: this._writeARR(rrser, data.rddata); break
      case DNSPacket.QType.NS: this._writeNSR(rrser, data.rddata); break
      case DNSPacket.QType.CNAME: this._writeCNAMER(rrser, data.rddata); break
      case DNSPacket.QType.SOA: this._writeSOAR(rrser, data.rddata); break
      case DNSPacket.QType.PTR: this._writePTRR(rrser, data.rddata); break
      case DNSPacket.QType.MX: this._writeMXR(rrser, data.rddata); break
      case DNSPacket.QType.TXT: this._writeTXTR(rrser, data.rddata); break
      case DNSPacket.QType.SRV: this._writeSRVR(rrser, data.rddata); break
      case DNSPacket.QType.AAAA: this._writeAAAAR(rrser, data.rddata); break
    }
